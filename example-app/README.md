...
This Laravel application demonstrates real-world usage of the [kduma/php-sdm](https://github.com/kduma-autoid/php-sdm) library for processing NTAG 424 DNA Secure Dynamic Messaging (SDM) data.
